...
<div class="col-12 col-sm-6 col-md-3 my-2">
    <a href="{{ route('movies.show', $movie['id']) }}" class="d-block">
        <img src="{{ 'https://image.tmdb.org/t/p/w500/'.$movie['poster_path'] }}" alt="poster" class="w-100">
    </a>
    ...
    <div class="d-block">
        <i class="fas fa-star text-yellow"></i><span class="ms-2">{{ $movie['vote_average'] * 10}}%</span>
        <span class="mx-2">|</span>{{ \Carbon\Carbon::parse($movie['release_date'])->format('Y年m月d日') }}
    </div>
    <div class="d-block">
        ジャンル：
